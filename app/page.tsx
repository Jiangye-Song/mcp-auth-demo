  ...
  const handleTestUnauthenticated = async () => {
    ...
    try {
      ...
      if (response.status === 401) {
        ...
        setResult(`✅ Authentication required (expected): ${errorData.error?.message || 'Unauthorized'}`)
      } else {
        const data = await response.json()
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8 p-4 rounded-md bg-blue-50 border border-blue-200">
            <h2 className="text-lg font-semibold text-blue-900 mb-2">Authentication Testing</h2>
            <p className="text-blue-800 mb-4">
              This MCP server now requires Google OAuth ID tokens for authentication.
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  <a href="https://developers.google.com/oauthplayground" className="text-blue-600 hover:underline">
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 p-4 rounded-md">
                  <h3 className="font-medium text-green-900 mb-2">OAuth Metadata Endpoint:</h3>
                ...
                <div className="bg-yellow-50 p-4 rounded-md">
                  <h3 className="font-medium text-yellow-900 mb-2">⚠️ Google OAuth Required</h3>
                  <p className="text-sm text-yellow-800">
                    This MCP server requires Google ID tokens for authentication.
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  To use this Google OAuth protected MCP server with Claude Desktop:
                </p>

                <div className="bg-orange-50 p-4 rounded-md">
                  <h3 className="font-medium text-orange-900 mb-2">OAuth Configuration</h3>
                  <p className="text-sm text-orange-800 mb-2">
                    Claude Desktop needs to authenticate with Google OAuth 2.0 to access this MCP server.
                    The server will validate Google ID tokens.
                  </p>
                  <p className="text-sm text-orange-800">
                    Authorization Server: <code>https://accounts.google.com</code>
                  </p>
                </div>
